...
; externs from ASM-only code
 ...
 externdef spr8T2entryvec_table:dword
...
LClampHigh5:
 ...
 jmp LClampReentry5
 align 4
 public _D_SpriteSpansStartT2
_D_SpriteSpansStartT2:
 public _D_SpriteDrawSpansT2
...
LClampReentry5:
 ...
 imul ds:dword ptr[reciprocal_table-8+ecx*4]
LSetEntryvec:
 mov ebx,ds:dword ptr[spr8T2entryvec_table+ecx*4]
 mov eax,edx
 push ebx
 mov ecx,ebp
 sar ecx,16
...
LOnlyOneStep:
 ...
 mov edx,ebx
 jmp LSetEntryvec
 public Spr8Entry2_8T2
Spr8Entry2_8T2:
 sub edi,6
 sub ecx,12
 mov al,ds:byte ptr[esi]
 jmp LLEntry2_8
 public Spr8Entry3_8T2
Spr8Entry3_8T2:
 sub edi,5
 sub ecx,10
 jmp LLEntry3_8
 public Spr8Entry4_8T2
Spr8Entry4_8T2:
 sub edi,4
 sub ecx,8
 jmp LLEntry4_8
 public Spr8Entry5_8T2
Spr8Entry5_8T2:
 sub edi,3
 sub ecx,6
 jmp LLEntry5_8
 public Spr8Entry6_8T2
Spr8Entry6_8T2:
 sub edi,2
 sub ecx,4
 jmp LLEntry6_8
 public Spr8Entry7_8T2
Spr8Entry7_8T2:
 dec edi
 sub ecx,2
 jmp LLEntry7_8
 public Spr8Entry8_8T2
Spr8Entry8_8T2:
 cmp bp,ds:word ptr[ecx]
 jl Lp9
 mov ah,ds:byte ptr[esi]
