...
_TEXT SEGMENT
 externdef _D_PolysetSetEdgeTable:dword
 externdef _D_RasterizeAliasPolySmooth:dword
 public _D_PolysetAff8StartT2
_D_PolysetAff8StartT2:
 public _D_PolysetCalcGradientsT2
_D_PolysetCalcGradientsT2:
 ...
 ret
 public _D_PolysetRecursiveTriangleT2
...
LDraw:
 ...
 mov eax,ds:dword ptr[0+esp]
 add eax,ds:dword ptr[_d_scantable+ebp*4]
 add eax,ds:dword ptr[_d_viewbuffer]
 bt cx,0
 jnc Skip1

; trans stuff 
 mov dl,ds:byte ptr[eax]
 and edx, 0ffffh
 mov dh,ds:byte ptr[12345678h + edx]
TranPatch1:

Skip1:
 mov ds:byte ptr[eax],dh
; rjr   distance
;  mov ds:byte ptr[eax],0
...
; pop ebp
 ...
 public _D_PolysetScanLeftEdgeT2
_D_PolysetScanLeftEdgeT2:
 push ebp
 push esi
 push edi
 push ebx
...
_L_PDFVertT2:
 ...
 and edx,000FFh
 add edi,edx
 add edi,ds:dword ptr[_acolormap]
 mov dh,ds:byte ptr[edi]
...
ret
 ...
 public _D_PolysetDrawFinalVertsT2
